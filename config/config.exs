...
config :ex_mon, ExMonWeb.Endpoint,
  ...
  live_view: [signing_salt: "FPfkopRJ"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
       issuer: "ex_mon",
       secret_key: "hmdJ4TwRgctosbg/IVS84GHnmzcAte4FaTG1518lmnZZwvU8EcDLTCbHrVaq+9+O"

config :ex_mon, ExMonWeb.Auth.Pipeline,
  module: ExMon.Auth.Guardian,
  error_handler: ExMon.Auth.ErrorHandler
